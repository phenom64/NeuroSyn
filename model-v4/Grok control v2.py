...
class ControlSystem:
    def __init__(self, predictor, bebop):
    ...
    async def run(self):
        ...
        async with Myo(myo_device) as myo:
            ...
            # Drone is already connected and taken off in __main__
...
async def main():
    control_system = ControlSystem(predictor, bebop)
...
if __name__ == "__main__":
    ...
    try: 
        ...
        bebop.set_max_altitude(MAX_ALTITUDE)  # Moved here from commented line
